Feature:
  ...
  Scenario: To calculate the score for with valid data for registered user.
    ...
    And   the user chooses a discipline
    When  the user enters a valid value
    Then  the user is able to see a correct point count


  Scenario: To calculate the score without entering value  for registered user.
    Given   the user is registered
    And     the user chooses a discipline
    When    the user doesnt enter a value
  ...
  Scenario: To calculate the score with negative value  for registered user.
    ...
    And     the user chooses a discipline
    When    the user doesnt enter a value
    Then   the error message should be displayed only positive values are allowed.

  Scenario: To calculate the score by entering  letters  for registered user.
    Given the user is registered
    And   the user chooses a discipline
    When  the user enters a value in letters
    Then  the error message should be displayed only numbers  are allowed.
